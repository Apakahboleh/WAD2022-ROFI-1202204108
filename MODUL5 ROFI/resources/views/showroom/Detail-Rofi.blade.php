...
@section('content')
    <head>
        <title>Halaman Detail Mobil</title>
    </head>
    <style>
        .tambah-title img {
            width: 450px;
            ...
            <div class="col-sm-5 offset-sm-6">
                <form action="/showroom/{{ $mobil["id"] }}/edit" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        value="{{ $mobil['purchase_date'] }}" disabled>
                    </div>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input type="textarea" name="description" class="form-control" id="floatingTextarea2"
                            style="height: 100px" value="{{ $mobil['description'] }}" disabled>
                    </div>

                    <div class="mb-3">
                        <label for="image" class="form-label">Image</label>
                        <input type="text" name="image" class="form-control" id="image"
                            value="{{ $mobil['image'] }}" disabled>
                    </div>
                    ...
                    <div class="mt-auto">
                        <div class="form-check-inline">
                            <input class="form-check-input" type="radio" name="Status" id="lunas"
                                value="Lunas" <?php if ($mobil['Status'] == 'Lunas') {
                                    echo 'checked';
                                } ?>>
                        ...
                        <div class="form-check-inline">
                            <input class="form-check-input" type="radio" name="Status" id="belum"
                                value="Belum-Lunas" <?php if ($mobil['Status'] == 'Belum-Lunas') {
                                    echo 'checked';
                                } ?>>
